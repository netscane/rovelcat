...
/// 上传音色对话框
class UploadVoiceDialog extends ConsumerStatefulWidget {
  const UploadVoiceDialog({super.key});

  @override
  ConsumerState<UploadVoiceDialog> createState() => _UploadVoiceDialogState();
}

class _UploadVoiceDialogState extends ConsumerState<UploadVoiceDialog> {
    ...
    if (result != null && result.files.single.bytes != null) {
      setState(() {
        ...
        if (_nameController.text.isEmpty) {
          final nameWithoutExt = _fileName!.replaceAll(RegExp(r'\.(wav|mp3|flac|ogg)$'), '');
